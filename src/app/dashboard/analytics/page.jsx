...
// Dynamically import DatePickerWithRange and disable SSR
const DatePickerWithRange = dynamic(
  () => import("@/components/ui/DatePickerWithRange"),
  { ssr: false }
);
      ...
      <SidebarInset>
        ...
        <div className="flex flex-1 flex-col gap-4 p-4 pt-0">
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            {/* DatePickerWithRange component is now client-only */}
          ...
          <div className="min-h-[100vh] flex-1 rounded-xl bg-muted/50 md:min-h-[calc(100vh-4rem)]" />
        </div>
      </SidebarInset>
    </SidebarProvider>
  );
